...
unweighted = ss.test_harm(source=source_scores, target=target_scores, worse="higher", rng=np.random.default_rng(1))
weighted = ss.test_harm(source=source_scores, target=target_scores, worse="higher", weights=w, rng=np.random.default_rng(1))
